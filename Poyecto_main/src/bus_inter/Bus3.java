...
public class Bus3 extends Thread {
    ...
    int retraso;
    int[][] corde = {
        {910, 470}, {900, 430}, {920, 400}, {930, 360}, {930, 345}, {940, 330}, {950, 310}, {960, 280},
        {910, 255}, {880, 245}, {860, 240}, {810, 215}, {790, 205}, {750, 190}, {730, 180},
        ...
        {920, 535}, {980, 520}, {950, 500}, {930, 480}, {910, 470}, {900, 430}, {920, 400}, {930, 360}};
    ...
    public Bus3(String nombre, JLabel label, int retraso) {
        this.nombre = nombre;
            ...
            for (int i = 0; i < corde.length; i++) {
                ...
                for (int j = 0; j < coordeParada.length; j++) {
                    if (corde[i][0] == coordeParada[j][0] && corde[i][1] == coordeParada[j][1]) {
                        try {
                            System.out.println("Bus 3 hace una parada en la " + coordeParada);
                            Thread.sleep(5000);
                        } catch (InterruptedException ex) {
