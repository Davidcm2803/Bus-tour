...
public class Bus4 extends Thread {
    ...
    int retraso;
    int[][] corde = {
        {880, 245}, {860, 240}, {810, 215}, {790, 205}, {750, 190}, {730, 180},
        ...
        {920, 535}, {980, 520}, {950, 500}, {930, 480}, {910, 470}, {900, 430}, {920, 400}, {930, 360}, {940, 330}, {950, 310},
        {960, 280}, {910, 255}};
    ...
    public Bus4(String nombre, JLabel label, int retraso) {
        this.nombre = nombre;
                ...
                for (int j = 0; j < coordeParada.length; j++) {
                    if (corde[i][0] == coordeParada[j][0] && corde[i][1] == coordeParada[j][1]) {
                        try {
                            ...
                            Logger.getLogger(Bus4.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                }
