...
public class Bus9 extends Thread {
    ...
    int retraso;
    int[][] corde = {
        {420, 128}, {390, 128}, {360, 125}, {320, 123}, {290, 119},
        ...
        {600, 155}, {580, 150}, {550, 145}, {520, 140}, {490, 130}, {460, 128}};
    ...
    public Bus9(String nombre, JLabel label, int retraso) {
        this.nombre = nombre;
       ...
       try {
        ...
        while (true) {
            for (int i = 0; i < corde.length; i++) {
                System.out.println("Bus 9 avanza");
